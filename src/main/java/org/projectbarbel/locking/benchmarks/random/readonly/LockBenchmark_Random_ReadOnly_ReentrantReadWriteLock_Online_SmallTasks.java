...
public class LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_Online_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_Online_SmallTasks() {
