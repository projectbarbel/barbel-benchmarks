...
public class LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_Batch extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_Batch() {
