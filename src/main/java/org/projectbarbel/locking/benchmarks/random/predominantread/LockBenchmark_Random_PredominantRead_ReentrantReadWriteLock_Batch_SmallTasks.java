...
public class LockBenchmark_Random_PredominantRead_ReentrantReadWriteLock_Batch_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantRead_ReentrantReadWriteLock_Batch_SmallTasks() {
