...
public class LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_Batch_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_Batch_SmallTasks() {
