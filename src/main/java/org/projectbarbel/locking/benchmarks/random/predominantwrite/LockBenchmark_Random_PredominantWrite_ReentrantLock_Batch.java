...
public class LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch.class.getSimpleName())
                .forks(1)
