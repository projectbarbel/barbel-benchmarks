...
public class LockBenchmark_Random_PredominantWrite_ReentrantLock_Online extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantLock_Online() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantWrite_ReentrantLock_Online.class.getSimpleName())
                .forks(1)
