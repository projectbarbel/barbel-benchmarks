...
public class LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch_SmallTasks() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantWrite_ReentrantLock_Batch_SmallTasks.class.getSimpleName())
                .forks(1)
